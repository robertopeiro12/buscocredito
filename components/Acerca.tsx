  ...
  return (
    <section className="w-full bg-white py-16" id="acerca">
      <div className="lg:max-w-6xl mx-auto max-w-lg px-5 lg:px-0">
        <h2 className="text-4xl lg:text-5xl font-bold mb-12 text-[#3B82F6]">
          Acerca de la plataforma
        </h2>
        <div className="flex lg:flex-row flex-col items-start justify-between">
          <p className="text-[#374151] text-xl lg:text-3xl lg:text-start text-center lg:max-w-3xl leading-relaxed">
