      ...
      <div className="max-w-[1400px] mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <Link href="/" className="flex items-center group">
            ...
            <span className="text-[#2EA043] text-2xl font-semibold ml-2 group-hover:text-green-700 transition-colors duration-300">
              BuscoCredito
            </span>
          </Link>
        </div>
        ...
        <div className="hidden lg:flex items-center space-x-10">
          <Link
            href="/acerca-de"
            className="text-gray-700 hover:text-[#2EA043] transition-colors duration-200 text-base font-medium relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-[#2EA043] after:left-0 after:-bottom-1 after:transition-all after:duration-300 hover:after:w-full"
          >
            Acerca de
          </Link>
          <Link
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="lg:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-sm border-b border-gray-100 p-4 shadow-lg">
